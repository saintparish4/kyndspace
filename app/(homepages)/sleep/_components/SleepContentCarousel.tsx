...
const SleepContentCarousel = () => (
  <section className="py-16 max-w-7xl mx-auto px-4">
    <h2 className="text-2xl font-bold mb-8 text-center">Sleep content - drift off with sleep meditations, sleep music, and more</h2>
...
export default SleepContentCarousel; 